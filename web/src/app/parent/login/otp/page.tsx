...
/** `Q-29` — phone OTP, kept as the RECOVERY path, not the default.
 *
 *  `D-13` moved the front door to school code + date of birth, but deleting
 *  this would leave the family whose child has no date of birth on record with
 *  no way in at all — and that is the school's gap, not theirs. It is also the
 *  more secure credential of the two, so it stays exactly as it was.
 */
    ...
    <AuthShell
      ...
      footer={
        <span className="space-x-3">
          <a href="/parent/login" className="font-medium text-primary">
            Use my school code instead
          </a>
